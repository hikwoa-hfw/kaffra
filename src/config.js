...
export const JUPITER_SLIPPAGE_BPS = Number(process.env.JUPITER_SLIPPAGE_BPS || 300); // 3%
export const JUPITER_PRIORITY_FEE_LAMPORTS = Number(process.env.JUPITER_PRIORITY_FEE_LAMPORTS || 100_000); 
export const JITO_TIP_LAMPORTS = Number(process.env.JITO_TIP_LAMPORTS || 10_000);
